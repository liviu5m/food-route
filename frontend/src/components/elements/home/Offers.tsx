  ...
  return (
    <div className="bg-[#F7F2E2] w-full flex items-center justify-center py-20">
      <div className="container flex items-center justify-between gap-10">
        <div className="w-1/3 flex justify-between gap-5 bg-white p-10 rounded-2xl">
        ...
        <div className="w-1/3 flex justify-between gap-5 bg-[#00A850] text-white p-10 rounded-2xl">
          <div className="flex flex-col justify-between">
        ...
        <div className="w-1/3 flex justify-between gap-5 bg-white p-10 rounded-2xl">
          <div className="flex flex-col justify-between">
            ...
            <Link to="/contact" className="text-[#FFCC00] font-bold text-xl">Contact us</Link>
          </div>
          <div>
