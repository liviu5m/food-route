  ...
  return (
    <div
      className={`w-full bg-white transition-all duration-300 ${
        isScrolled
          ? "fixed top-0 left-0 right-0 shadow-md z-50 py-4"
          : "py-8"
      }`}
    >
          ...
          <div className="flex items-center justify-between">
            ...
            <ul className="flex items-center justify-center gap-10">
              ...
              <Link
                to="/products"
                className={`hover:text-[#FFCC00] font-semibold ${
                  pathname == "/products" ? "text-[#FFCC00]" : "text-[#1E1D23]"
                }`}
              >
                Products
              </Link>
              <Link
                to="/services"
                className={`hover:text-[#FFCC00] font-semibold ${
                  pathname == "/services" ? "text-[#FFCC00]" : "text-[#1E1D23]"
                }`}
              >
                Services
              </Link>
            ...
            <div className="flex items-center justify-center gap-10">
              {user ? (
                <Menu as="div" className="relative inline-block text-left">
                  <div>
                    <MenuButton className="inline-flex w-full justify-center gap-x-1.5 text-sm shadow-xs ring-gray-300 px-10 py-3 cursor-pointer outline-none bg-[#FFCC00] text-[#1E1D23] rounded-lg font-semibold hover:text-[#FFCC00] hover:bg-[#1E1D23] items-center gap-5">
                      {user.username}
